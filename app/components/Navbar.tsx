  ...
  return (
    <nav className={`navbar${scrolled ? ' scrolled' : ''}`} role="navigation" aria-label="Main navigation">
      <div className="navbar-inner">
        {/* Logo */}
        <Link href="/" className="nav-logo" aria-label="Cockroach Janta Party Home">
          ...
          <div className="nav-logo-text">
            <span className="nav-logo-title">COCKROACH<br />JANTA PARTY</span>
            <span className="nav-logo-hindi">कॉकरोच जनता पार्टी · EST. 2026</span>
          </div>
        </Link>
